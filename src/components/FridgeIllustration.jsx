export function FridgeIllustration({ size = 96, className = '' }) {
  return (
    ...
    >
      <rect x="16" y="8" width="60" height="86" rx="18" fill="#FCEFDD" stroke="#F86A1E" strokeWidth="5" />
      ...
      <path
        d="M86 14c.3 2.4.9 4 1.7 4.8.8.8 2.4 1.4 4.8 1.7-2.4.3-4 .9-4.8 1.7-.8.8-1.4 2.4-1.7 4.8-.3-2.4-.9-4-1.7-4.8-.8-.8-2.4-1.4-4.8-1.7 2.4-.3 4-.9 4.8-1.7.8-.8 1.4-2.4 1.7-4.8Z"
        fill="#FAA046"
      />
    </svg>
  );
